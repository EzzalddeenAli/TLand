...
public class HotelsCentersActivity extends BaseActivity {
    ...
    public void DeclareElements() {
        ...
        layoutManager = new LinearLayoutManager(HotelsCentersActivity.this);
        rv.setLayoutManager(layoutManager);
        adapter = new KishCentersAdapter(HotelsCentersActivity.this, imageLoader);
    ...
    private void GetCenters() {
        ...
        new AsynctaskKishgardiCenters(HotelsCentersActivity.this, params, m).getData();
    }
}
